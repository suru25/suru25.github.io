...
<html lang="en">
<head>
    <title>Kumari Suruchi Sah | Web App Developer</title>
    <!-- Meta -->
    <meta charset="utf-8">
...
<body>
    ...
    <header class="header">
        <div class="container clearfix">                       
            <img class="profile-image img-fluid float-left" src="assets/images/62108190-woman-girl-glasses-computer-gears-developer-web-responsive-development-website-programming-icon-set-.jpg" alt="Kumari Suruchi Sah" style="border-radius: 50%;" />
            <div class="profile-content float-left">
                <h1 class="name">Kumari Suruchi Sah</h1>
                <h2 class="desc">Web App Developer</h2>   
                <ul class="social list-inline">
                                       
                    <li class="list-inline-item"><a href="https://plus.google.com/109603760707776406780" target="_blank"><i class="fab fa-google-plus-g"></i></a></li>
                    <li class="list-inline-item"><a href="https://www.linkedin.com/in/kumari-suruchi-sah-087987130/" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                    <li class="list-inline-item"><a href="https://github.com/suru25" target="_blank"><i class="fab fa-github-alt" target="_blank"></i></a></li>               
                </ul> 
            </div><!--//profile-->
            <a class="btn btn-cta-primary float-right" href="https://mail.google.com/mail/?view=cm&fs=1&to=suruchi1607034@nitp.ac.in" target="_blank"><i class="fas fa-paper-plane"></i> Contact Me</a>              
        </div><!--//container-->
    </header><!--//header-->
            ...
            <div class="primary col-lg-8 col-12">
                <section class="about section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <p>Hello, I am Kumari Suruchi Sah,  A developer. I love reading books and listening to music. And I love to code :p</p>
               ...
               <section class="skills section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <p class="intro">
                                  My skills showcase!</p>
                            
                            <div class="skillset">
                               
                                <div class="item">
                                    <h3 class="level-title">Python<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to explain more about your skill level..."><i class="fas fa-info-circle"></i>Intermediate</span></h3>
                                    <div class="level-bar">
                                ...
                                <div class="item">
                                    <h3 class="level-title">HTML5 &amp; CSS3 <span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to explain more about your skill level..."><i class="fas fa-info-circle"></i>Expert</span></h3>
                                    <div class="level-bar">
                                ...
                                <div class="item">
                                    <h3 class="level-title">PHP &amp; MySQL<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to explain more about your skill level..."><i class="fas fa-info-circle"></i>Pro</span></h3>
                                    <div class="level-bar">
                                        <div class="level-bar-inner" data-level="96%">
                                        </div>                                      
                                    </div><!--//level-bar-->                                 
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><i class="fas fa-map-marker-alt"></i><span class="sr-only">Location:</span>Patna, Bihar, India</li>
                                <li><i class="fas fa-envelope"></i><span class="sr-only">Email:</span><a href="https://mail.google.com/mail/?view=cm&fs=1&to=suruchi1607034@nitp.ac.in" target="_blank" >suruchi1607034@nitp.ac.in</a></li>
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <div class="item">                      
                                ...
                                <h4 class="university">National Institute of Technology Patna, Bihar <span class="year">(2016-2020)</span></h4>
                            </div><!--//item-->
                            <!--//item-->
                        </div><!--//content-->
                    </div><!--//section-inner-->                 
